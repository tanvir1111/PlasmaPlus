...
public class ExplorePatientViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public ExplorePatientViewHolder(@NonNull View itemView, ArrayList<PatientDataModel> patientDataModels) {
        super(itemView);
