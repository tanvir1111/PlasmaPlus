...
public class ResponsesFromDonorsAlphaAdapter extends RecyclerView.Adapter<ResponsesFromDonorsAlphaViewHolder> {
    ...
    public ResponsesFromDonorsAlphaAdapter(Context context, ArrayList<PatientDataModel> patientDataModels , String status) {
    ...
    @NonNull
    @Override
    public ResponsesFromDonorsAlphaViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.seeking_help_child, parent, false);
        ResponsesFromDonorsAlphaViewHolder responsesFromDonorsAlphaViewHolder = new ResponsesFromDonorsAlphaViewHolder(view, patientDataModels, status);

        return responsesFromDonorsAlphaViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ResponsesFromDonorsAlphaViewHolder holder, int position) {
