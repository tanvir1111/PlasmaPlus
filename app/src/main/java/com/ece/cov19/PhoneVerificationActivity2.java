...
public class PhoneVerificationActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(PhoneVerificationActivity2.this,"Phone: "+phonenumber,Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(PhoneVerificationActivity2.this, "Verification Failed! "+task.getException().getMessage().toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
